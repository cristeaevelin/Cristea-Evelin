...
const TrueFocus = ({
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="absolute w-4 h-4 border-[3px] rounded-[3px] top-[20px] left-[-10px] border-r-0 border-b-0"
          style={{
        ...
        ></span>
        <span
          className="absolute w-4 h-4 border-[3px] rounded-[3px] top-[20px] right-[-10px] border-l-0 border-b-0"
          style={{
            borderColor: "var(--border-color)",
            filter: "drop-shadow(0 0 4px var(--border-color))",
          }}
